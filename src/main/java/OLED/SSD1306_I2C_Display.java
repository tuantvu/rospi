...
public class SSD1306_I2C_Display {
    ...
    /**
     * Default constructor for 128x64 OLED display using I2CBus 1,
     * device address 0x3c and no reset pin
     * @throws UnsupportedBusNumberException 
     * @throws IOException 
     */
    public SSD1306_I2C_Display() throws IOException, UnsupportedBusNumberException {
		this(SSD1306_Constants.LCD_WIDTH_128,
